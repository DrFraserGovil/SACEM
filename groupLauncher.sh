 ./submit -threads 28 -random 10000000 -grid 101 -dir Output/ModelM_All -mode 1 -dt 0.2 -constrain m -allfrac 1
 ./submit -threads 28 -random 10000000 -grid 101 -dir Output/ModelM_Cold -mode 1 -dt 0.2 -constrain m -allfrac 0
 ./submit -threads 28 -random 10000000 -grid 101 -dir Output/ModelL_All -mode 1 -dt 0.2 -constrain l -allfrac 1
